...
function Aa(a,b,c,e){var d;if(E(c))d=c;else{var f=za(a,c,b.context);if(c=f[1]){e||(e={});for(d in c)if(a=e[d],b=c[d],a)for(var g in b)a[+g]=!0;else e[d]=b;return[null,e]}d=f[0]}if(d.length&&b.invCount&1){a:{c=a.g(b);g=M.clone(b.context);M.j(g,b);c=L(b.siteId,b.seqId,g,0,c);for(var h=[],f=[],k=0;k<d.length;k++)M.m(g,d[k].context)?h.push(d[k]):f.push(d[k]);if(h.length)if(e=Aa(a,c,h,e),c=e[0],e=e[1],c)g=c.context,M.a(g,b.siteId,b.seqId,0),b.load=a.g(c),b.context=g;else{e=[null,f,e];break a}e=[b,f,e]}b=
e[0];d=e[1];e=e[2];if(!b)return[null,e]}for(g=0;g<d.length;g++){c=d[g];if(f=k=a.c[c.siteId])a:{f=c;h=b.context;if((k=k.c[f.seqId-k.a]||null)&&k.cache)for(var k=k.cache,l=0;l<k.length;l++){var n=k[l];if(!(!!(f.invCount&1)^n.X)&&M.i(h,k[l].context)){f=L(f.siteId,f.seqId,M.clone(h),f.invCount,n.load);break a}}f=null}if(f=f||null)c=f;else if(e=Aa(a,c,b.context,e),c=e[0],e=e[1],!c)return[null,e];null!=b.load&&null!=c.load&&(f=a.j(b,c),h=a.j(c,b),b.load=f,c.load=h);M.a(b.context,c);Fa(a,b);M.a(c.context,
b);Fa(a,c)}return[b,e]}
...
e&&h}return e}return Jb(a,new T(b,this))}function Cb(a){a=a[xb];return a instanceof tb?a:null}var Kb="__closure_events_fn_"+(1E9*Math.random()>>>0);function Bb(a){if("function"==ga(a))return a;a[Kb]||(a[Kb]=function(b){return a.handleEvent(b)});return a[Kb]};function U(){Oa.call(this);this.b=new tb(this);this.aa=this;this.I=null}na(U,Oa);U.prototype[pb]=!0;U.prototype.removeEventListener=function(a,b,c,e){Gb(this,a,b,c,e)};U.prototype.f=function(){U.J.f.call(this);if(this.b){var a=this.b,b=0,c;for(c in a.a){for(var e=a.a[c],d=0;d<e.length;d++)++b,sb(e[d]);delete a.a[c];a.b--}}this.I=null};
function Lb(a,b,c,e){b=a.b.a[String(b)];if(!b)return!0;b=b.concat();for(var d=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.o&&g.A==c){var h=g.listener,k=g.B||g.src;g.w&&wb(a.b,g);d=!1!==h.call(k,e)&&d}}return d&&0!=e.P};function V(a,b){U.call(this);this.i=a||1;this.c=b||z;this.l=la(this.ga,this);this.m=J()}na(V,U);V.prototype.h=!1;V.prototype.a=null;
...
m.Z=function(a,b){var c=[];if(this.H(a,b)){var e=this.a[a][b];c[0]=e.u;c[1]=e.D?this.O(a,b):null;e.u=[];e.D=!1;e.v=W()}return c};function W(){return(new Date).getTime()}function Ob(a,b,c){void 0!==c||(c=W());return b+a.c>c}var X=Mb.prototype;X.connect=X.connect;X.disconnect=X.M;X.collect=X.G;X.isConnected=X.H;X.getConnectedSites=X.O;X.popUpdates=X.Z;X.registerUpdates=X.$;X.startCollectionCycle=X.ea;X.stopCollectionCycle=X.fa;X.setConnectionTimeout=X.ca;X.setCollectionInterval=X.ba;
...
64<p,q=[],C=[],D={},B={};D[1]=0;B[1]=0;for(var t,u,y={},H=!1,ma=!!y.hasOwnProperty,I=(h+n)%2,A=0;A<p&&!((new Date).getTime()>l);A++){q[A]={};for(var x=-A;x<=A;x+=2){t=x==-A||x!=A&&D[x-1]<D[x+1]?D[x+1]:D[x-1]+1;u=t-x;r&&(d=t+","+u,I&&(ma?y.hasOwnProperty(d):void 0!==y[d])&&(H=!0),I||(y[d]=A));for(;!H&&t<h&&u<n&&f.charAt(t)==g.charAt(u);)t++,u++,r&&(d=t+","+u,I&&(ma?y.hasOwnProperty(d):void 0!==y[d])&&(H=!0),I||(y[d]=A));D[x]=t;q[A][t+","+u]=!0;if(t==h&&u==n){d=Xb(q,f,g);break a}if(H){C=C.slice(0,y[d]+
1);d=Xb(q,f.substring(0,t),g.substring(0,u));d=d.concat(Yb(C,f.substring(t),g.substring(u)));break a}}if(r)for(C[A]={},x=-A;x<=A;x+=2){t=x==-A||x!=A&&B[x-1]<B[x+1]?B[x+1]:B[x-1]+1;u=t-x;d=h-t+","+(n-u);!I&&(ma?y.hasOwnProperty(d):void 0!==y[d])&&(H=!0);for(I&&(y[d]=A);!H&&t<h&&u<n&&f.charAt(h-t-1)==g.charAt(n-u-1);)t++,u++,d=h-t+","+(n-u),!I&&(ma?y.hasOwnProperty(d):void 0!==y[d])&&(H=!0),I&&(y[d]=A);B[x]=t;C[A][t+","+u]=!0;if(H){q=q.slice(0,y[d]+1);d=Xb(q,f.substring(0,h-t),g.substring(0,n-u));d=
...
var ac=[function(a,b){var c=a.load,e=c.at,d=b.load,f=d.at,d=d.value.length;return e>f||e==f&&a.siteId>b.siteId?Y(e+d,c.value):c},function(a,b){var c=a.load,e=c.at,d=b.load,f=d.at,d=d.value.length;return e>f?e>=f+d?Y(e-d,c.value):null:c},function(a,b){var c=a.load,e=c.at,d=c.value,f=b.load,g=f.at,f=f.value,h=f.length;return e>=g?Z(e+h,d):e+d.length>g?(d=d.substring(0,g-e)+f+d.substring(g-e),Z(e,d)):c},function(a,b){var c=a.load,e=c.at,d=c.value,f=d.length,g=b.load,h=g.at,k=Math.max(h-e,0),g=Math.min(h+
g.value.length-e,f);if(k<=g){if(!k){if(g==f)return null;e+=g+1}d=d.substring(0,k)+d.substring(g);return Z(e,d)}return c}],bc=[function(a){return Z(a.load.at,a.load.value)},function(a){return Y(a.load.at,a.load.value)}];function cc(a,b){var c=b.load;if(c){c=dc[c.type];if(!c)throw"Wrong operations passed to an exec function.";a=c(a,b)}return a}
